...
const config: runtime.GetPrismaClientConfig = {
  ...
  "inlineSchema": "datasource db {\n  provider = \"postgresql\"\n}\n\ngenerator client {\n  provider = \"prisma-client\"\n  output   = \"./generated\"\n}\n\nmodel ShortnedUrl {\n  id  Int    @id @default(autoincrement())\n  key String @unique\n  url String\n\n  @@index([key], name: \"key_index\", type: Hash)\n}\n",
  "runtimeDataModel": {
    "models": {},
    "enums": {},
    "types": {}
...
config.runtimeDataModel = JSON.parse("{\"models\":{\"ShortnedUrl\":{\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"type\":\"Int\"},{\"name\":\"key\",\"kind\":\"scalar\",\"type\":\"String\"},{\"name\":\"url\",\"kind\":\"scalar\",\"type\":\"String\"}],\"dbName\":null}},\"enums\":{},\"types\":{}}")
config.parameterizationSchema = {
  strings: JSON.parse("[\"where\",\"ShortnedUrl.findUnique\",\"ShortnedUrl.findUniqueOrThrow\",\"orderBy\",\"cursor\",\"ShortnedUrl.findFirst\",\"ShortnedUrl.findFirstOrThrow\",\"ShortnedUrl.findMany\",\"data\",\"ShortnedUrl.createOne\",\"ShortnedUrl.createMany\",\"ShortnedUrl.createManyAndReturn\",\"ShortnedUrl.updateOne\",\"ShortnedUrl.updateMany\",\"ShortnedUrl.updateManyAndReturn\",\"create\",\"update\",\"ShortnedUrl.upsertOne\",\"ShortnedUrl.deleteOne\",\"ShortnedUrl.deleteMany\",\"having\",\"_count\",\"_avg\",\"_sum\",\"_min\",\"_max\",\"ShortnedUrl.groupBy\",\"ShortnedUrl.aggregate\",\"AND\",\"OR\",\"NOT\",\"id\",\"key\",\"url\",\"equals\",\"in\",\"notIn\",\"lt\",\"lte\",\"gt\",\"gte\",\"contains\",\"startsWith\",\"endsWith\",\"not\",\"set\",\"increment\",\"decrement\",\"multiply\",\"divide\"]"),
...
export interface PrismaClientConstructor {
   ...
   * })
   * // Fetch zero or more ShortnedUrls
...
/**
  ...
  $extends: runtime.Types.Extensions.ExtendsHook<"extends", Prisma.TypeMapCb<OmitOpts>, ExtArgs, runtime.Types.Utils.Call<Prisma.TypeMapCb<OmitOpts>, {
    extArgs: ExtArgs
      ...
      /**
   * `prisma.shortnedUrl`: Exposes CRUD operations for the **ShortnedUrl** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more ShortnedUrls
    * const shortnedUrls = await prisma.shortnedUrl.findMany()
    * ```
    */
  get shortnedUrl(): Prisma.ShortnedUrlDelegate<ExtArgs, { omit: OmitOpts }>;
}
